    ...
    if ($block == "left")
        $link = "<a href='themes/NB-H20-2c/blockswitcher.php?switch=right'><img src='themes/NB-H20-2c/images/rcol.png' border='0'></a>";
    else
        $link = "<a href='themes/NB-H20-2c/blockswitcher.php?switch=left'><img src='themes/NB-H20-2c/images/lcol.png' border='0'></a>"; 
    ?>
            </td>
            <!-- END RIGHT COLUMN -->
          </tr>
	...
	<?php endif; # Changed. ?> 
      ...
      <div class='shad-r'><img src='themes/NB-H20-2c/images/blank.gif' width='9px' height='9px' /></div>
    </div>
    <div class='myTrow'>
      <div class='shad-bl'><img src='themes/NB-H20-2c/images/blank.gif' width='9px' height='9px' /></div>
      <div class='shad-b'><img src='themes/NB-H20-2c/images/blank.gif' width='9px' height='9px' /></div>
      <div class='shad-br'><img src='themes/NB-H20-2c/images/blank.gif' width='9px' height='9px' /></div>
    </div>
  </div>
  <br />
  <div class="fltLeft">
