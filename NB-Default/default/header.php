...
<!-- THIS IS THE TOP LOGO AREA 3 CELLS -->
		<TD WIDTH=497 height="80"><a href="index.php"><IMG SRC="themes/default/images/template1_01.jpg" WIDTH=497 HEIGHT=80 border=0 ALT="<? echo $SITENAME  ?> logo" ></a></TD>
		<TD WIDTH=141 height="132" ROWSPAN=3><IMG SRC="themes/default/images/template1_02.jpg" WIDTH=141 HEIGHT=132 ALT=""></TD>
		<TD height="132" ROWSPAN=3 background="themes/default/images/template1_03.jpg">&nbsp;</TD>
<!-- END TOP LOGO AREA -->	
	</TR>
	<TR>
<!-- TOP NAV MENU AND USER RATIO AREA -->
		<TD WIDTH=497 HEIGHT=24 valign="top" background="themes/default/images/template1_04.jpg">
			<FONT COLOR=#FFFFFF>&nbsp;
			<? if ($CURUSER) {
	...
	<TR>
		<TD WIDTH=497 HEIGHT=28 valign="middle" background="themes/default/images/template1_05.jpg">
...
if ($arow['comment'] == 'on'){
       echo'<br><a href="./show-archived.php?id=' . $row['id'] . '">Comment on this article. (' . $row['comments'] . ') Replys so far';
       }
       //}
end_frame();
}
