...
<!-- CSS -->
<!-- Theme css -->
<link rel="shortcut icon" href="<?php echo $site_config["SITEURL"]; ?>/themes/NB-H20-2c/images/favicon.ico" />
<link rel="stylesheet" type="text/css" href="<?php echo $site_config["SITEURL"]; ?>/themes/NB-H20-2c/theme.css" />
<!-- JS -->
<script type="text/javascript" src="<?php echo $site_config["SITEURL"]; ?>/backend/java_klappe.js"></script>
<!--[if lte IE 6]>
    <script type="text/javascript" src="<?php echo $site_config["SITEURL"]; ?>/themes/NB-H20-2c/js/pngfix/supersleight-min.js"></script>
<![endif]-->
</head>
<?php
...
<!-- START INFOBAR -->
    ...
    print (",  <img src='themes/NB-H20-2c/images/downloaded.png' border='none' height='20' width='20' alt='Downloaded' title='Downloaded'> <font color='#CC0000'>$userdownloaded </font> <img src='themes/NB-H20-2c/images/uploaded.png' border='none' height='20' width='20' alt='Uploaded' title='Uploaded'> <font color='#009900'>$useruploaded</font> <img src='themes/NB-H20-2c/images/ratio.png' border='none' height='20' width='20' alt='Ratio' title='Ratio'> $userratio");
    
    echo " <a class='profile' href='account.php'><img src='themes/NB-H20-2c/images/account.png' border='none' height='20' width='20' alt='Your account' title='Your account'></a> <a class='account' href='account-details.php?id=$CURUSER[id]'><img src='themes/NB-H20-2c/images/profile.png' border='none' height='20' width='20' alt='Profile' title='Profile'></a> <a class='logout' href=\"account-logout.php\"><img src='themes/NB-H20-2c/images/logout.png' border='none' height='20' width='20' alt='Logout' title='Logout'></a> ";
    ...
    if ($unreadmail){
        ...
        print("<a class='mail_n' href=mailbox.php?inbox><img src='themes/NB-H20-2c/images/mail_new.png' border='none' height='20' width='20' alt='New PM' title='($unreadmail) New PM'S'><font color='red'>($unreadmail)</font></a>&nbsp;");
    
    }else{
    
        print("<a class='mail' href=mailbox.php><img src='themes/NB-H20-2c/images/mail.png' border='none' height='20' width='20' alt='My Messages' title='My Messages'></a>&nbsp;");
...
<!-- END INFOBAR -->
    ...
    <div class='header'>
      <div id='logo'><a href='index.php'><img src='themes/NB-H20-2c/images/blank.gif' width='360' height='64' /></a></div>
    </div>
    <div id='menu'>
      <!-- START NAVIGATION -->
  ...
  <div class='myTable'>
    <div class='myTrow'>
      <div class='shad-l'><img src='themes/NB-H20-2c/images/blank.gif' width='9px' height='9px' /></div>
      <div class='main'>
