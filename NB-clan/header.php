...
<link rel="stylesheet" type="text/css" href="themes/NB-clan/theme.css" />
...
<tr valign="top"> 
<td width="40" height="186" rowspan="2"><img src="themes/NB-clan/images/page_01.jpg" width="40" height="186"></td>
<td height="46" colspan="2" align="center" valign="middle" background="themes/NB-clan/images/page_02.jpg"><FONT COLOR=#FFFFFF>
  <? if ($CURUSER) {
		...
		//end
			?>
&nbsp;&#8595;&nbsp;<font color=red><? print mksize($CURUSER[downloaded]);?></font> - <b>&#8593;&nbsp;</b><font color=yellow><? print mksize($CURUSER[uploaded]);?></font> - <? print("" . RATIO . "\n"); ?>: <? print $userratio; ?> &nbsp;
...
<td width="41" rowspan="2"><img src="themes/NB-clan/images/page_04.jpg" width="41" height="186"></td>
</tr>
<tr valign="top">
  <td width="391" height="140"><img src="themes/NB-clan/images/page_logo.jpg" width="391" height="140"></td>
  <td align="left" valign="bottom" background="themes/NB-clan/images/page_06.jpg"><p><FONT COLOR=#FFFFFF><br>
    </FONT><br>
    <br>
  </p></td>
</tr>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
<tr> 
<td width="24" valign="top" background="themes/NB-clan/images/page_08.jpg"><IMG SRC="themes/NB-clan/images/page_08.jpg" WIDTH=24 HEIGHT=11 ALT=""></td>
<td background="themes/NB-clan/images/page_12.jpg">
<div align="center">
<table width="99%" border="0" cellspacing="0" cellpadding="5">
<tr>
  <div align="center">
    <!--- DEBUT colonne de gauche --->
    <a class=menu_blink href=index.php><strong><? print("" . HOME . "\n"); ?></strong></a> <strong>&bull;
    <?if ($FORUMS) {?>
    <a class=menu_blink href=forums.php><? print("" . FORUMS . "\n"); ?></a> &bull;
    <?}?>
    <?if ($IRCCHAT) {?>
    <a class=menu_blink href=irc.php><? print("" . CHAT . "\n"); ?></a> &bull;
    <?}?>
    <a class=menu_blink href=torrents-search.php><? print("" . SEARCH . "\n"); ?></a> &bull; <a class=menu_blink href=torrents-upload.php><? print("" . UPLOADT . "\n"); ?></a> &bull; <a class=menu_blink href=faq.php><? print("" . FAQ . "\n"); ?></a></strong><a class=menu_blink href=faq.php></a>
  </div>
<div align="center">
  <tr>
...
<table border=0 width=100% cellspacing=0 cellpadding=0>
    ...
    <tr>
  <td align="center"><a class=menu_blink href="account-delete.php"><?echo "" . DELETE_ACCOUNT . "";?></a><br><a class=menu_blink href="account-recover.php"><?echo "" . RECOVER_ACCOUNT . "";?></a></td> </tr>
  </table>
  <?
end_block();
...
?>
  <table border="0" width="100%" cellspacing="0" cellpadding="0">
    ...
    <tr>
    <td align="center"><a class=menu_blink href="account.php"><? print("" . ACCOUNT . "\n"); ?></a> <br> <? if (get_user_class() > UC_VIP) {
print("<a class=menu_blink href=admin.php>" . STAFFCP . "</a>");}?></font></tr>
  </table>
  <?
end_block();
...
if ($CURUSER)
{
  ...
  <table border="0" width="100%" cellspacing="0" cellpadding="0">
    ...
    <?if ($invites > 0 ){?>
    <tr><td align="center"><a class=menu_blink href=invite.php><? print("" . SENDANDINVITE . "\n"); ?></a><br></td></tr>
    <?}?>
  </table>
  <?
		end_block();
...
?>
  ...
  · <a class=menu_blink href="index.php"><? print("" . HOME . "\n"); ?></a><br />
  &nbsp;&nbsp;· <a class=menu_blink href="torrents-search.php"><? print("" . SEARCH_TITLE . "\n"); ?></a><br />
  &nbsp;&nbsp;· <a class=menu_blink href="torrents-upload.php"><? print("" . UPLOADT . "\n"); ?></a><br />
  &nbsp;&nbsp;· <a class=menu_blink href="torrents-needseed.php"><? print("" . UNSEEDED . "\n"); ?></a><br />
  &nbsp;&nbsp;· <a class=menu_blink href="viewrequests.php"><? print("" . REQUESTED . "\n"); ?></a><br />
  &nbsp;&nbsp;· <a class=menu_blink href="today.php"><? print("" . TODAYS_TORRENTS . "\n"); ?></a><br />
  <br />
  <CENTER>
    <a href="rssinfo.php"><img src="images/rss2.gif" border=0 alt="XML RSS Feed"></a>
  </CENTER>
  <hr>
  · <a class=menu_blink href="faq.php"><? print("" . FAQ . "\n"); ?></a><br />
  · <a class=menu_blink href="extras-stats.php"><? print("" . TRACKER_STATISTICS . "\n"); ?></a><br />
  <?if ($FORUMS) {?>
  · <a class=menu_blink href="forums.php"><? print("" . FORUMS . "\n"); ?></a><br />
  <?}?>
  <?if ($IRCCHAT) {?>
  · <a class=menu_blink href="irc.php"><? print("" . CHAT . "\n"); ?></a><br />
  <?}?>
  · <a class=menu_blink href="formats.php"><? print("" . FILE_FORMATS . "\n"); ?></a><br />
  · <a class=menu_blink href="videoformats.php"><? print("" . MOVIE_FORMATS . "\n"); ?></a><br />
  · <a class=menu_blink href="staff.php"><? print("" . STAFF . "\n"); ?></a><br />
  · <a class=menu_blink href="rules.php"><? print("" . SITE_RULES . "\n"); ?></a><br />
  · <a class=menu_blink href="extras-users.php"><? print("" . MEMBERS . "\n"); ?></a><br />
  <hr>
  · <a class=menu_blink href="visitorsnow.php"><? print("" . ONLINE_USERS . "\n"); ?></a><br />
  · <a class=menu_blink href="visitorstoday.php"><? print("" . VISITORS_TODAY . "\n"); ?></a><br />
  
  <?if(get_user_class() > UC_VIP) {?>
  <hr>
  · <a class=menu_blink href="admin.php"><? print("" . STAFFCP . "\n"); ?></a><br />
  <?}?>
  <br />
...
print "<div align=left><B><font color=#FF6600>&#187;</font></B> <a class=menu_blink href=\"donate.php\">" . DONATE . "</a><br>";
end_block();
}
